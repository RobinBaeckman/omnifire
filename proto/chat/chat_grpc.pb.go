...
func (c *chatClient) Talk(ctx context.Context, in *TalkRequest, opts ...grpc.CallOption) (*TalkResponse, error) {
	out := new(TalkResponse)
	err := c.cc.Invoke(ctx, "/chat.Chat/Talk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServer) Talk(context.Context, *TalkRequest) (*TalkResponse, error) {
...
func _Chat_Talk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).Talk(ctx, req.(*TalkRequest))
	}
